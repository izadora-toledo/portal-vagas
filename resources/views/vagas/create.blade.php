...
<div class="container">
    ...
    <main>
        <form method="POST"
              action="{{ $vaga->id ? route('vagas.update', $vaga->id) : route('vagas.store') }}">
            @csrf
            @if ($vaga->id)
                @method('PUT')
            @endif
            ...
            <div class="form-group">
                ...
                <select name="tipo_contratacao" class="form-control">
                    ...
                    <option value="Freelancer"
                            {{ $vaga->tipo_contratacao == 'Freelancer' ? 'selected' : '' }}>Freelancer</option>
                </select>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <select name="status" class="form-control">
                    ...
                    <option value="ENCERRADO"
                            {{ $vaga->status == 'ENCERRADO' ? 'selected' : '' }}>Encerrado</option>
